    ...
    <div className='h-full bg-fixed' style={{ backgroundImage: `url(${background})` }}>
        ...
        <div className="grid h-full container mx-auto">  
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 space-y-4 md:space-y-0 mb-10 md:mb-0 px-6 md:px-0">
              <Card img={buah3} name='Anggur Red Globe' idP='1' price='13.500' price2='24.500' />
              <Card img={buah2} name='Anggur Hijau' idP='2' price='19.000' price2='36.000' />
              <Card img={buah1} name='Anggur Hitam' idP='3' price='14.000' price2='26.000' />
          </div>
        </div>
        <Footer />
    </div>
